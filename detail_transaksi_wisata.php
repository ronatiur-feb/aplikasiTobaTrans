		...
		<div class="row">
			<div class="col-sm-10">
				...
				<table class="table">
					...
					<?php if($riwayats['metode_bayar'] == "Transfer ATM" && $riwayats['bukti_bayar'] != "belum dikirim"){ ?>
					<tr>
						<th>Bukti Bayar</th>
						<td><img src="image/bukti_bayar/<?=$riwayats['bukti_bayar'];?>" style="width: 200px; height: 250px;" ></td>
					</tr>
					<tr>
