		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">	
				...
				<div class="carousel-caption" style="padding-bottom: 300px;font-style: arial; ">
					...
					<br>
					<p style="font-size: 20px;">Kami siap mengantar anda di sekitaran Toba Samosir</p>
					<form action="#layanan">
...
<div class="container" style="padding:20px 0px 50px 0px;">
	<h3>Kami menyediakan Tiga Layanan</h3>
  <div class="row">
    <div class="col-sm-4">
      <h3>Toba Car</h3>
...
anda inginkan</p>
    ...
    <div class="col-sm-4">
      <h3>Toba Box</h3>	
      <p style="font-size: 17px;">Merupakan jasa pengiriman paket 
dan siap mengantarkan barang anda 
ke tempat tujuan di sekitaran Danau Toba</p>
    </div>	
    <div class="col-sm-4">
      <h3>Paket Wisata</h3>        
